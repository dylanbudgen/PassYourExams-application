...
import ***REMOVED***PassYourExams.Database.DataBaseHelper;
import ***REMOVED***PassYourExams.Database.DatabaseReader;
import ***REMOVED***PassYourExams.ImageAdapters.ModuleImageAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static String DB_PATH = "/data/data/***REMOVED***PassYourExams/databases/QUESTIONS_TEST";

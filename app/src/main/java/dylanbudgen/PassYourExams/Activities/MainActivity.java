...
import dylanbudgen.PassYourExams.Database.DataBaseHelper;
import dylanbudgen.PassYourExams.Database.DatabaseReader;
import dylanbudgen.PassYourExams.ImageAdapters.ModuleImageAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static String DB_PATH = "/data/data/dylanbudgen.PassYourExams/databases/QUESTIONS_TEST";
